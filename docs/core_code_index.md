...
- Purpose: classical multifractal baseline estimators for aggregate structure
  functions, MFDFA, Haar wavelet-leader approximation, and Haar WTMM-style
  modulus maxima.
- Status: paper supplement / classical baseline support.
- Main API: `estimate_classical_zeta`.
- Related scripts: `experiments/run_classical_multifractal_baseline_comparison.py`,
